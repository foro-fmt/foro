# This is copy of os.py from the CPython standard library
# The license for the original file is: https://github.com/python/cpython/blob/37e533a39716bf7da026eda2b35073ef2eb3d1fb/LICENSE
...
class _Environ(MutableMapping):
    ...
    if _exists("_create_environ"):
        ...
        def refresh(self):
            ...
            if name == "nt":
                data = {self.encodekey(key): value for key, value in data.items()}
